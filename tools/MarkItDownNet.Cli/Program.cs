...
if (args.Length == 0)
{
    Console.WriteLine("Usage: markitdownnet <convert|bench|ocr|mdgen|mdcompare|mdmanifest|mdcheck> [options]");
    return;
}
...
switch (args[0])
{
    ...
    case "mdgen":
        ...
        break;
    case "mdcompare":
        MdCompareCommand.Run(args.Skip(1).ToArray());
        break;
    case "mdmanifest":
        MdManifestCommand.Run(args.Skip(1).ToArray());
        break;
    case "mdcheck":
        MdCheckCommand.Run(args.Skip(1).ToArray());
        break;
    default:
